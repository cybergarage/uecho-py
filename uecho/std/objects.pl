...
#
# GENERATED FROM __objects__.pl DO NOT EDIT THIS FILE.

from .object import Object
from .property import Propery
...
while(<DEVLIST>){
  ...
  while(<DEV>){
    ...
    printf("obj.add_property(Propery(0x%s, \"%s\", \"%s\", %d, \"%s\", \"%s\", \"%s\", \"%s\"))\n",
      $epc,
      $name,
      $data_type,
      $data_size,
